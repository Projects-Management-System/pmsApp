...
// ----------------------------------------------------------------------
// ---------------------------------------------------------------------
export default function VendorsDatabasesZTE() {
  ...
  const [projectNameDropdownValue, setProjectNameDropdownValue] = useState('All ZTE Projects');
    ...
    <Page title="Vendor Projects Databases | Project Management Database">
      <Stack direction="row" alignItems="center" justifyContent="space-between" mb={1}>
        <Typography variant="h6" gutterBottom>
          Vendor Projects Databases - ZTE Projects
        </Typography>
      </Stack>
        ...
        >
          <Button color="primary" variant="outlined">
            <Link
              ...
              to="/dashboard/DatabasesVendorProjectsZTE/PendingTasks/Home"
            >
              Pending Tasks
            </Link>
          </Button>
          <Button color="primary" variant="outlined">
            <Stack direction="row" alignItems="center" justifyContent="space-between" spacing={0.2}>
              ...
              <Link
                underline="hover"
                component={RouterLink}
                to="/dashboard/DatabasesVendorProjects/AddNew/ZTE"
              >
                Add New
              </Link>
            </Stack>
