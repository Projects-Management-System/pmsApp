...
function getHandOverData(posts) {
  ...
  handOverData.push((posts.filter((obj) => ((obj.HO_Date !== ''))).filter((obj) => ((obj.Site_Status !== 'Site Withdrawn'))).length));
...
//---------------------------------------------------------------------------------------------------------------------------
//---------- Functions getting HO scope, PAT scope, Completed scope to the Mobitel Projects Overvoew Data Table  ------------
//---------------------------------------------------------------------------------------------------------------------------
